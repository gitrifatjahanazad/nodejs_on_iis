...
01. install IISNODE from [here](https://github.com/tjanczuk/iisnode/releases/download/v0.2.21/iisnode-full-v0.2.21-x64.msi) 
02. install Node js
03. install url rewrite module
04. after installing IISNode .msi goto "C:\Program Files\iisnode"
05. run the setupsamples.bat and press any key. (Run it as administrator)
06. browse the url as localhost/node
07. for hosting your own site on iis, create a website on iis
08. make a web.config on the mentioned physical path
    ```
    <configuration>
        <system.webServer>
    ...
    ```
09. remember to change the hello.js to your server.js file and hit the website. It whould work.
